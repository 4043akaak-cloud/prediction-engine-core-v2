/**
 * Stock Default Recipe
 * The first official default recipe for the Prediction Engine Core (PEC)
 * 
 * A balanced stock prediction recipe that demonstrates the core philosophy of PEC
 * by combining multiple reasoning approaches rather than relying on a single method.
 */
...
export const STOCK_DEFAULT_RECIPE = {
  ...
  // Recipe Philosophy
  philosophy: "This recipe provides a balanced prediction by combining market trend analysis, statistical reasoning, probabilistic updating, causal reasoning, behavioral psychology, strategic interaction, business fundamentals, intrinsic valuation, and uncertainty simulation. The goal is not to maximize prediction accuracy for one specific strategy, but to demonstrate how multiple independent reasoning engines can work together.",
  ...
  rationale: {
    ...
    description: "This recipe combines the most essential reasoning approaches for stock prediction:",
    reasons: [
